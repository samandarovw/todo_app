import 'package:aking/app/ui/pages/login_page.dart';
    ...
    return Scaffold(
      ...
      body: IntroductionScreen(
        ...
        globalFooter: Stack(
          ...
          children: [
            SvgPicture.asset(
              Assets.imagesIntroBg,
              width: MediaQuery.of(context).size.width,
              color: intro_bg_color,
            ),
            Column(
              children: [
                SizedBox(
                ...
                CupertinoButton(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        "Get Started",
                        style:
                            TextStyle(fontSize: 18, color: Color(0xff313131)),
                      ),
                    ),
                    onPressed: () {
        ...
        onChange: (value) {
          if (value == 0) {
            intro_bg_color = Color(0xffF96060);
          } else if (value == 1) {
            intro_bg_color = Color(0xff6074F9);
          } else if (value == 2) {
            intro_bg_color = Color(0xff8560F9);
          }
          setState(() {});
        },
